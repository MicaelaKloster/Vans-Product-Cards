...
const vansBg = document.querySelectorAll('.vans_background');
...
function changeColor(){
    ...
    let color_circle = this.getAttribute('color');
...
function changeHeight(){
    if(x.matches){
        ...
        document.querySelector('.vans_background').style.height = `${vansHeight * 0.9}px`;
    }
    else{
        document.querySelector('.vans_background').style.height = "475px";
